...
// |                                                                      |
// +----------------------------------------------------------------------+
$oF->addRule('usr',       $I18N['element.error.req'],        'required');
$oF->addRule('usr',       $I18N['element.error.exists'],     'unique', array($USER, "usr"));

$oF->addRule('email',     $I18N['element.error.req'],        'required');
$oF->addRule('email',     $I18N['element.error.exists'],     'unique', array($USER, "email"));
